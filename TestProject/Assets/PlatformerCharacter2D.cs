...
// This class is from unity standard assets package
public class PlatformerCharacter2D : MonoBehaviour
{
    ...
    private void Flip()
    {
		...
		// Flip the x scale
		playerGraphics.transform.localScale = new Vector3 (-playerGraphics.localScale.x, playerGraphics.localScale.y, playerGraphics.localScale.z);
    }
}